...
Namespace Cyhper
    Friend Class CMD5
        ...
        Private Function AddUnsigned(ByVal lX As Integer, ByVal lY As Integer) As Integer
            ...
            'Dim r1 As Short = CShort(lY And &H3FFFFFFF)
            'Dim r2 As Short = CShort(lX And &H3FFFFFFF)
            'lResult = CShort(lX And &H3FFFFFFF) + CShort(lY And &H3FFFFFFF)
    ...
    Public Class CGenericRegistration
        ...
        Public Function GenerateKey(ByRef sAppChars As String) As String
            ...
            'UPGRADE_NOTE: Object oMD5 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
            oMD5 = Nothing
    ...
    Public Class RegistrationProcess
        Const MAXUSEDAYS As Integer = 30
        Const INSTALLONCEID_KEY As String = "WTFdOuThinkURDoing!"
        ...
        Private Sub GetRegKeys(ByVal strRegPath As String, ByRef RegName As String, ByRef RegKey As String, ByRef ExpDate As String)
            ...
            Else
                RegName = oD.DecryptSHA(MyReg.GetValue("SetHistListtb", ""))
                RegKey = oD.DecryptSHA(MyReg.GetValue("SetHistListdt", ""))
                ExpDate = oD.DecryptSHA(MyReg.GetValue("HistKeyList", ""))
            End If
        End Sub
        Private Sub SaveRegKeys(ByVal strRegPath As String, ByRef MyregName As String, ByRef MyRegKey As String, ByRef ExpDate As String)
            Dim MyReg As RegistryKey
            MyregName = ""
            MyRegKey = ""
            ExpDate = ""
            ...
            If MyReg Is Nothing Then
                ...
                MyReg.SetValue("HistKeyList", ExpDate)
                MyReg.SetValue("SetHistListdt", MyRegKey)
                MyReg.SetValue("SetHistListtb", MyregName)
        ...
        Public Sub JustSave(ByVal strRegPath As String, ByVal strName As String, ByVal strKey As String)
            ...
            MyReg.SetValue("SetHistListdt", oE.EncryptSHA(strKey))
            MyReg.SetValue("SetHistListtb", oE.EncryptSHA(strName))
            MyReg.Close()
        End Sub
    End Class
End Namespace
